/*
	custom compile java by Shawn CHollette. Based on Roots Theme by Ben Word, the creators of Twitter Bootstrap.
	main.js
*/
jQuery(document).ready(function($) {
	...
	$('.tubepress_thumbs').flexslider({
	slideshowSpeed: 20000,           //Integer: Set the speed of the slideshow cycling, in milliseconds
	directionNav: false,             //Boolean: Create navigation for previous/next navigation? (true/false)
	controlsContainer: ".tubepress_thumbs"
	});
	/*---------------------------------
		MANUAL CALLS TO TWITTER BOOTSTRAP STUFF
	-----------------------------------*/
	$("#example").popover();  
	$('.tiptip').tooltip(); 
	$('.carousel').carousel({
