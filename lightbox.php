...
<div id="person-<?php echo $counter ;?>" class="personbig"><!--START OF PERSON BIG -->
    ...
    <a class="personclose" href="javascript:parent.$.fancybox.close();"><i class="icon-remove"></i><i class="icon-remove-circle"></i><i class="icon-remove-sign"></i></a>
    </header>
    <section class="personbody"><!--START OF PERSON BODY -->
        <article class="persondetails"><!--START OF PERSON META -->
            ...
            <a href="mailto:<?php echo $person_mb->the_value('email'); ?>" class="btn"><i class="icon-envelope"></i> <i class="icon-envelope-alt"></i> <?php echo $person_mb->the_value('email'); ?></a>
            </button>
            <?php } ?>             
	...
	<nav class="personnav">
    <a class="personclose" href="javascript:parent.$.fancybox.prev();"><i class="icon-chevron-left"></i></a>
    <a class="personclose" href="javascript:parent.$.fancybox.next();"><i class="icon-chevron-right"></i></a>
    </nav>
